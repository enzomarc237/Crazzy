  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        color: isDark ? MacosColors.white.withValues(alpha: 0.05) : MacosColors.white,
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
          color: isDark ? MacosColors.white.withValues(alpha: 0.1) : const Color(0xFFE5E5E5),
        ),
        boxShadow: [
          if (!isDark)
            BoxShadow(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 11,
              color: isDark ? MacosColors.white.withValues(alpha: 0.5) : const Color(0xFF755E8D),
            ),
          ),
          const Spacer(),
          Row(
            children: [
              ...
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                decoration: BoxDecoration(
                  color: isDark ? MacosColors.white.withValues(alpha: 0.05) : const Color(0xFFF2F0F5),
                  borderRadius: BorderRadius.circular(4),
                ),
                child: Text(
                  'Q4',
