        ...
        Row(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(color: const Color(0xFF007AFF).withValues(alpha: 0.1), borderRadius: BorderRadius.circular(99)),
        ...
        child: BackdropFilter(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(color: Colors.black.withValues(alpha: 0.25), blurRadius: 60, offset: const Offset(0, 30)),
              ],
            ),
            child: Column(
              mainAxisSize: MainAxisSize.min,
