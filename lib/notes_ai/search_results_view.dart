  ...
  Widget _buildHeader(BuildContext context, bool isDark) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDark ? MacosColors.windowBackgroundColor.withValues(alpha: 0.8) : Colors.white.withValues(alpha: 0.8),
        border: Border(
          bottom: BorderSide(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isSemantic
              ...
              : (isDark ? Colors.white.withValues(alpha: 0.1) : const Color(0xFFE5E5E5)),
        ),
      ),
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 11,
                  color: isDark ? Colors.white.withValues(alpha: 0.4) : const Color(0xFF755E8D),
                ),
              ),
            ],
          ),
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 13,
              height: 1.5,
              color: isDark ? Colors.white.withValues(alpha: 0.6) : const Color(0xFF755E8D),
            ),
            maxLines: 2,
