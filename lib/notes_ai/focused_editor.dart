...
class FocusedEditorView extends StatelessWidget {
  ...
  Widget _buildParagraph(String text, bool isDark) {
    return Text(
      ...
      style: TextStyle(
        fontSize: 18,
        height: 1.6,
        color: isDark ? Colors.white.withValues(alpha: 0.8) : const Color(0xFF3A3A3C),
      ),
    );
  }
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: isDark ? Colors.white.withValues(alpha: 0.1) : const Color(0xFFE5E5E5)),
                  boxShadow: [
  ...
  Widget _buildDivider(bool isDark) {
    return Container(width: 1, height: 16, color: isDark ? Colors.white.withValues(alpha: 0.1) : const Color(0xFFE5E5E5));
  }
